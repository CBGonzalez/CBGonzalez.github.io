---
layout: post
title: A MVVM WPF News Ticker in C#
excerpt: The news ticker will periodically fetch headlines from Hacker News using its API, from a select group of reddit communities via RSS and from BBCNews, also via its RSS service.
date: 2019-06-05
categories: [.net, MVVM]
---
...
![NewsTicker screenshot](/images/Screeny.png)
...
A schematic view of the project can be found [here](/images/Diagram.png).
...
![Validation-field](/images/Validation.png)
